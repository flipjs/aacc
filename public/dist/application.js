...
angular.module('articles').config(['$stateProvider',
	function($stateProvider) {
		...
		state('articles.list', {
			...
			resolve: {
				articles: /* ngInject */ ["Articles", function(Articles) {
		...
		state('articles.view', {
			...
			resolve: {
				article: /* ngInject */ ["$stateParams", "Articles", function($stateParams, Articles) {
...
void (function() {
	...
	ArticlesCreateController.$inject = ["$scope", "$stateParams", "$location", "Authentication", "Articles"];
})()
...
void (function() {
	...
	ArticlesEditController.$inject = ["$scope", "$location", "Authentication", "article"];
})()
...
void (function() {
	...
	ArticlesListController.$inject = ["$scope", "Authentication", "articles"];
})()
...
void (function() {
	...
	ArticlesViewController.$inject = ["$scope", "$location", "Authentication", "article"];
})()
